<section id="about" data-link="about" class="lg-bg single-section">
  <div class="single-section--pi-2">
    <div class="inner-wrapper--1680-lg">
      ...
      <div class="col-wrapper col-wrapper--tablet">
        <div class="left-col">
          <img src="assets/img/rob.webp" alt="Image of me from a previous job">
        </div>
      ...
      <div class="col-wrapper col-wrapper--desktop">
        <div class="left-col">
          <img src="assets/img/rob.webp" alt="Image of me from a previous job">
        </div>
        <div class="right-col">
